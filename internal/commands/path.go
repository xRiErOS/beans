...
Resolution follows the usual precedence (--beans-path, BEANS_PATH, beans.anchor,
config directory), so scripts that need the store can ask for it here instead of
re-deriving it and drifting from the CLI.`,
